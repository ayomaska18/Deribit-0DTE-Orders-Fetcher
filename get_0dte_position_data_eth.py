...
def filter_orders(trades: list, instrument_name: str):
    ...
    save_trades_to_csv(buy_calls, 'ETH_buy_calls')
    save_trades_to_csv(sell_calls, 'ETH_sell_calls')
    save_trades_to_csv(buy_puts, 'ETH_buy_puts')
    save_trades_to_csv(sell_puts, 'ETH_sell_puts')
...
def main():
    ...
    instruments_ETH = get_instruments('ETH', 'option', 'true')

    ETH_0dte = get_0dte_instruments(instruments_ETH, start_timestamp, end_timestamp)

    print(ETH_0dte)

    for instrument in ETH_0dte:
